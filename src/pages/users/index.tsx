...
import { List_Item_api_get, users_api_get_Config } from '../../model/api-models/users/Users_api_get'
    ...
    <>
      ...
      >
        <main className='md:mx-8'>
          ...
          <Table<List_Item_api_get['output']['users'][0]>
            ...
            data={data && data.outputData && data.outputData.users}
            ...
            fields={{
              ...
              Email: (item) => <div>{item.email}</div>,
              Role: (item) => <div>{item.role}</div>,
            }}
          />
        </main>
      </Layout>
